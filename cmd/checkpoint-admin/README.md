...
*For a more detailed introduction to checkpoint, please see the LES [spec](https://github.com/qtumproject/devp2p/blob/master/caps/les.md).*
...
```shell
go get github.com/qtumproject/go-ethereum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/qtumproject/go-ethereum/blob/master/params/config.go#L251).*
